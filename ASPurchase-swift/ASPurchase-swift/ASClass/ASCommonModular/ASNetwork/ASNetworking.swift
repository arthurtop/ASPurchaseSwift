...
public let AS = ASNetworking.shared
...
public class ASNetworking {
    /// For singleton pattern
    public static let shared = ASNetworking()
    ...
    var ASheaders: HTTPHeaders = ["Content-type" : "application/json;charset=utf-8",
                                "Accept":"application/json",
                                "Authorization": "",
                                "app-version":"1.4.0"
                                ]
    
    var baseUrl = ASBaseUrl
...
//    }
    ...
    public func request<Parameters: Encodable>(url: String,
                        method: HTTPMethod = .get,
                        parameters: Parameters? = nil,
                        headers: [String: String]? = nil,
                        encoding: ParameterEncoder = URLEncodedFormParameterEncoder.default) -> HWNetworkRequest {
        let task = HWNetworkRequest()
        
        var h: HTTPHeaders? = ASheaders
...
extension ASNetworking {
    ...
    @discardableResult  //Parameters? = nil
    public func POST<Parameters: Encodable>(url: String, parameters: Parameters? = nil,_ headers: [String: String]? = nil) -> HWNetworkRequest {
//        request(url: baseUrl+url, method: .post, parameters: parameters, headers: nil)
        
        request(url: baseUrl+url, method: .post, parameters: parameters, headers: headers, encoding: JSONParameterEncoder.default)
    ...
    /// - note: more see: `self.request(...)`
    @discardableResult
    public func POST(url: String, parameters: [String: String]? = nil,_ headers: [String: String]? = nil, datas: [HWMultipartData]? = nil) -> HWNetworkRequest {
        guard datas != nil else {
            return request(url: baseUrl+url, method: .post, parameters: parameters, headers: nil)
        }
        return upload(url: baseUrl+url, parameters: parameters, datas: datas!, headers: headers)
    }
    
    /// Creates a GET request
    /// - note: more see: `self.request(...)`
    @discardableResult
    public func GET<Parameters: Encodable>(_ url: String, parameters:Parameters? = nil, headers: [String: String]? = nil) -> HWNetworkRequest {
//        request(url: baseUrl+url, method: .get, parameters: parameters, headers: nil)
        
        request(url: baseUrl+url, method: .get, parameters: parameters, headers: headers, encoding: JSONParameterEncoder.default)
    }
}
...
//            .disposed(by: disposeBag)
    ...
    func testJson(){
        ...
        let url = URL(string:surStr)
//        let url = URL(string: "http://www.tuling123.com/openapi/api?key=20ff1803ff65429b809a310653c9daac?info=深圳")
...
//        https://easy-mock.com/mock/5f1aa78b2da6de5e62cede96/example/demo1?name=sole&pass=123
        
        /*
        guard let urls = URL(string: "http://www.tuling123.com/openapi/api?key=20ff1803ff65429b809a310653c9daac?info=深圳") else { return }
        
        var request = URLRequest(url: urls)
        let parameters = ["info": "北京","key":"20ff1803ff65429b809a310653c9daac"]
        do {
